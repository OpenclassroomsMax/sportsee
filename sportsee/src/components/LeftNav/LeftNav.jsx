    ...
    return (  
        <aside className='leftnav_container'>
            <nav className='leftnav_navigation'>
                <NavLink className= "link_icon" to='/'><img src={iconMeditation} alt="icone meditation" /></NavLink>
				<NavLink className= "link_icon" to='#'><img src={iconNage} alt="icone meditation" /></NavLink>
				<NavLink className= "link_icon" to='#'><img src={iconVelo} alt="icone meditation" /></NavLink>
				<NavLink className= "link_icon" to='#'><img src={iconHaltere} alt="icone meditation" /></NavLink>
            </nav>
